...
- (int64_t)freeDeviceMemory
{
    ...
    return (long long)(free_mem_in_bytes / 1024);
}
...
- (int64_t)totalDeviceMemory
{
    ...
    uint64_t total_mem_in_bytes = (vmstat.wire_count + vmstat.active_count + vmstat.inactive_count + vmstat.free_count + vmstat.compressor_page_count) * pagesize;
    return (long long)(total_mem_in_bytes / 1024);
}
